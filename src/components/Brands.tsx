    ...
    <div className="my-2 w-64">
      ...
      <div className="shadow-md bg-white pl-3 py-2 my-2">
        <div className="relative flex items-center flex-1 pr-3">
          <input type="text" className="bg-slate-50 inline-block w-full px-7 py-1 rounded-sm my-1" placeholder="Search" onChange={(e) => dispatch(setSearchedBrands(e.target.value))} />
